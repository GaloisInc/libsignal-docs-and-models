...
-- core::option::Option::map is shared; imported from PQXDH.Aeneas2.Extracted.Shared.Core.

-- core::option Try::branch + FromResidual::from_residual are shared (PQXDH.Aeneas2.Extracted.Shared.Core).
...
-- core::result Try::branch + FromResidual::from_residual are shared (PQXDH.Aeneas2.Extracted.Shared.Core).
...
-- alloc::vec::Vec::into_boxed_slice is shared; imported from PQXDH.Aeneas2.Extracted.Shared.Alloc.
