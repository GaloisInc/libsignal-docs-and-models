...
def load_tracked_labels(docs_dir: Path) -> set[str]:
    # Track every authored Blueprint definition/theorem atom.
    labels: set[str] = set()
...
def print_html_summary(atoms: list[Atom], history_file: Path | None = None, site_dir: Path | None = None) -> None:
    ...
    print('        <ul>')
    print('          <li class="status-ref-item"><a class="status-ref-title" href="https://signal.org/docs/specifications/pqxdh/" target="_blank" rel="noreferrer noopener">The PQXDH Key Agreement Protocol</a><span class="status-ref-authors">Ehren Kret, Rolfe Schmidt</span><span class="status-ref-venue">Signal Specifications</span></li>')
    print('          <li class="status-ref-item"><a class="status-ref-title" href="https://eprint.iacr.org/2016/1150" target="_blank" rel="noreferrer noopener">Unilaterally-Authenticated Key Exchange</a><span class="status-ref-authors">Yevgeniy Dodis, Dario Fiore</span><span class="status-ref-venue">Financial Cryptography and Data Security 2017</span></li>')
    print('          <li class="status-ref-item"><a class="status-ref-title" href="https://eprint.iacr.org/2017/117" target="_blank" rel="noreferrer noopener">No-Match Attacks and Robust Partnering Definitions</a><span class="status-ref-authors">Yong Li, Sven Schäge</span><span class="status-ref-venue">ACM CCS 2017</span></li>')
    ...
    print('          <li class="status-ref-item"><a class="status-ref-title" href="https://github.com/protoben/libsignal-verify" target="_blank" rel="noreferrer noopener">libsignal-verify (project source)</a><span class="status-ref-authors">Lean/VCVio specification and proofs for the PQXDH protocol</span><span class="status-ref-venue">GitHub Repository</span></li>')
    print('        </ul>')
    print('      </section>')
    print('    </section>')
