...
- **Security definitions, PQXDH spec model, and security theorems:** Human-written code. These are delicate definitions that are part of the trust-base of the project. I initially experimented with using Claude to define them, but I found that it tended to simplify things in ways that had significant security ramifications. The workflow I landed on eventually was to write the definitions myself, and then have Claude check my work for fidelity to the papers, e.g., by generating small examples or cross-referencing my definitions and comments with the paper. I was also able to use Claude for small mechanical changes here.
